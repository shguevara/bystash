...
$settings   = array(
	...
	'general' => array(
		...
		'subscription_module'     => array(
			'title'            => __( 'Subscription Module', 'yith-woocommerce-sequential-order-number' ),
			'subtitle'         => __( 'Available only with YITH WooCommerce Subscription Premium', 'yith-woocommerce-sequential-order-number' ),
			'type'             => 'yith-field',
			'class'            => ywson_is_subscription_active() ? '' : 'yith-disabled',
			'yith-type'        => 'toggle-element-fixed',
			'yith-display-row' => false,
			'id'               => 'ywson_subscription_module_settings',
			'elements'         => array(
				array(
					'title'             => __( 'Numeration starting from:', 'yith-woocommerce-sequential-order-number' ),
					'type'              => 'number',
					'desc'              => __( 'Set the starting number for subscription numeration', 'yith-woocommerce-sequential-order-number' ),
					'id'                => 'order_number',
					'default'           => 1,
					'custom_attributes' => "min=1 step=1 required",
				),
				array(
					'title'             => __( 'Subscription prefix', 'yith-woocommerce-sequential-order-number' ),
					'type'              => 'text',
					'id'                => 'order_prefix',
					'desc'              => sprintf( '%s <br> %s', __( 'Set a text to be used as prefix for subscription numbers.', 'yith-woocommerce-sequential-order-number' ), $desc_tip ),
					'custom_attributes' => 'placeholder ="Ex: YWSON_SUBSCRIPTION-"',
					'default'           => '',
				),

				array(
					'title'             => __( 'Subscription suffix', 'yith-woocommerce-sequential-order-number' ),
					'type'              => 'text',
					'id'                => 'order_suffix',
					'desc'              => sprintf( '%s <br> %s', __( 'Set a text to be used as suffix for subscription numbers.', 'yith-woocommerce-sequential-order-number' ), $desc_tip ),
					'custom_attributes' => 'placeholder="Ex: -YWSON_SUBSCRIPTION"',
					'default'           => '',
				),
			),
