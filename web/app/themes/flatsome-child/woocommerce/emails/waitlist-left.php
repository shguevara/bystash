...
<div id="waitlist-wrapper">
	<div class="copy-container">
		...
		<p><?php echo _x('Hola', 'Email salutation', 'woocommerce-waitlist'); ?>, esta es una confirmación de que fuiste eliminado <br />de la lista de espera para:<br /></p>
		...
		<p><?php printf(__('Si te eliminaste por error y querés volver a agregarte podes hacer %sclic&nbsp;acá%s.', 'woocommerce-waitlist'), '<a href="' . esc_attr($product_link) . '">', '</a>'); ?></p>

		<p>
			<a class="cta-button-large" href="<?php echo $shop_page_url ?>?utm_source=waitlist&amp;utm_medium=email&amp;utm_campaign=left&amp;utm_content=btn_top-ver-mas-productos">Ver más productos</a>
		</p>
		</p>
...
include(get_template_directory() . '-child/common/email-footer-mkt.php');
?>